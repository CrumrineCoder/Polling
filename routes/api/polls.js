...
router.post("/rescind", (req, res, next) => {
  ...
  Polls.updateMany({"userAnswers.value": 0 }, { $pull: {  "userAnswers.value": { $elemMatch: {value: 0, value: 1} } } }, function(err, docs){console.log("FIND ERR", err);console.log("FIND DOC", docs)});
    Polls.updateMany(
